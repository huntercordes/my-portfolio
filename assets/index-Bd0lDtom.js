...
#endif`,U3="gl_FragColor = linearToOutputTexel( gl_FragColor );",L3=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function W2(i,e,t){const r=new Float32Array(kr),o=new he(0,1,0);return new ui({name:"SphericalGaussianBlur",defines:{n:kr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:wu(),fragmentShader:`
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function rv(){return new ui({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:wu(),fragmentShader:`
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function sv(){return new ui({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wu(),fragmentShader:`
		...
		`,blending:Li,depthTest:!1,depthWrite:!1})}function wu(){return`
...
`)+`
`+_);const A=w+S+u,N=w+_+f,P=pv(o,o.VERTEX_SHADER,A),L=pv(o,o.FRAGMENT_SHADER,N);o.attachShader(M,P),o.attachShader(M,L),t.index0AttributeName!==void 0?o.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&o.bindAttribLocation(M,0,"position"),o.linkProgram(M);function F(H){if(i.debug.checkShaderErrors){const j=o.getProgramInfoLog(M)||"",ne=o.getShaderInfoLog(P)||"",ee=o.getShaderInfoLog(L)||"",K=j.trim(),I=ne.trim(),W=ee.trim();let Y=!0,pe=!0;if(o.getProgramParameter(M,o.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(o,M,P,L);else{const O=gv(o,P,"vertex"),re=gv(o,L,"fragment");cn("THREE.WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(M,o.VALIDATE_STATUS)+`
...
}`;function TR(i,e,t){let r=new V_;const o=new _t,l=new _t,u=new un,f=new ZE({depthPacking:oE}),d=new KE,p={},g=t.maxTextureSize,x={[Ea]:Cn,[Cn]:Ea,[si]:si},v=new ui({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new _t},radius:{value:4}},vertexShader:MR,fragmentShader:ER}),y=v.clone();y.defines.HORIZONTAL_PASS=1;const b=new Aa;b.setAttribute("position",new Si(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new qi(b,v),S=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=y_;let _=this.type;this.render=function(L,F,q){if(S.enabled===!1||S.autoUpdate===!1&&S.needsUpdate===!1||L.length===0)return;const D=i.getRenderTarget(),C=i.getActiveCubeFace(),H=i.getActiveMipmapLevel(),j=i.state;j.setBlending(Li),j.buffers.depth.getReversed()===!0?j.buffers.color.setClear(0,0,0,0):j.buffers.color.setClear(1,1,1,1),j.buffers.depth.setTest(!0),j.setScissorTest(!1);const ne=_!==va&&this.type===va,ee=_===va&&this.type!==va;for(let K=0,I=L.length;K<I;K++){const W=L[K],Y=W.shadow;if(Y===void 0){ft("WebGLShadowMap:",W,"has no shadow.");continue}if(Y.autoUpdate===!1&&Y.needsUpdate===!1)continue;o.copy(Y.mapSize);const pe=Y.getFrameExtents();if(o.multiply(pe),l.copy(Y.mapSize),(o.x>g||o.y>g)&&(o.x>g&&(l.x=Math.floor(g/pe.x),o.x=l.x*pe.x,Y.mapSize.x=l.x),o.y>g&&(l.y=Math.floor(g/pe.y),o.y=l.y*pe.y,Y.mapSize.y=l.y)),Y.map===null||ne===!0||ee===!0){const re=this.type!==va?{minFilter:oi,magFilter:oi}:{};Y.map!==null&&Y.map.dispose(),Y.map=new Oi(o.x,o.y,re),Y.map.texture.name=W.name+".shadowMap",Y.camera.updateProjectionMatrix()}i.setRenderTarget(Y.map),i.clear();const O=Y.getViewportCount();for(let re=0;re<O;re++){const Se=Y.getViewport(re);u.set(l.x*Se.x,l.y*Se.y,l.x*Se.z,l.y*Se.w),j.viewport(u),Y.updateMatrices(W,re),r=Y.getFrustum(),N(F,q,Y.camera,W,this.type)}Y.isPointLightShadow!==!0&&this.type===va&&w(Y,q),Y.needsUpdate=!1}_=this.type,S.needsUpdate=!1,i.setRenderTarget(D,C,H)};function w(L,F){const q=e.update(M);v.defines.VSM_SAMPLES!==L.blurSamples&&(v.defines.VSM_SAMPLES=L.blurSamples,y.defines.VSM_SAMPLES=L.blurSamples,v.needsUpdate=!0,y.needsUpdate=!0),L.mapPass===null&&(L.mapPass=new Oi(o.x,o.y)),v.uniforms.shadow_pass.value=L.map.texture,v.uniforms.resolution.value=L.mapSize,v.uniforms.radius.value=L.radius,i.setRenderTarget(L.mapPass),i.clear(),i.renderBufferDirect(F,null,q,v,M,null),y.uniforms.shadow_pass.value=L.mapPass.texture,y.uniforms.resolution.value=L.mapSize,y.uniforms.radius.value=L.radius,i.setRenderTarget(L.map),i.clear(),i.renderBufferDirect(F,null,q,y,M,null)}function A(L,F,q,D){let C=null;const H=q.isPointLight===!0?L.customDistanceMaterial:L.customDepthMaterial;if(H!==void 0)C=H;else if(C=q.isPointLight===!0?d:f,i.localClippingEnabled&&F.clipShadows===!0&&Array.isArray(F.clippingPlanes)&&F.clippingPlanes.length!==0||F.displacementMap&&F.displacementScale!==0||F.alphaMap&&F.alphaTest>0||F.map&&F.alphaTest>0||F.alphaToCoverage===!0){const j=C.uuid,ne=F.uuid;let ee=p[j];ee===void 0&&(ee={},p[j]=ee);let K=ee[ne];K===void 0&&(K=C.clone(),ee[ne]=K,F.addEventListener("dispose",P)),C=K}if(C.visible=F.visible,C.wireframe=F.wireframe,D===va?C.side=F.shadowSide!==null?F.shadowSide:F.side:C.side=F.shadowSide!==null?F.shadowSide:x[F.side],C.alphaMap=F.alphaMap,C.alphaTest=F.alphaToCoverage===!0?.5:F.alphaTest,C.map=F.map,C.clipShadows=F.clipShadows,C.clippingPlanes=F.clippingPlanes,C.clipIntersection=F.clipIntersection,C.displacementMap=F.displacementMap,C.displacementScale=F.displacementScale,C.displacementBias=F.displacementBias,C.wireframeLinewidth=F.wireframeLinewidth,C.linewidth=F.linewidth,q.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const j=i.properties.get(C);j.light=q}return C}function N(L,F,q,D,C){if(L.visible===!1)return;if(L.layers.test(F.layers)&&(L.isMesh||L.isLine||L.isPoints)&&(L.castShadow||L.receiveShadow&&C===va)&&(!L.frustumCulled||r.intersectsObject(L))){L.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,L.matrixWorld);const ne=e.update(L),ee=L.material;if(Array.isArray(ee)){const K=ne.groups;for(let I=0,W=K.length;I<W;I++){const Y=K[I],pe=ee[Y.materialIndex];if(pe&&pe.visible){const O=A(L,pe,D,C);L.onBeforeShadow(i,L,F,q,ne,O,Y),i.renderBufferDirect(q,null,ne,O,L,Y),L.onAfterShadow(i,L,F,q,ne,O,Y)}}}else if(ee.visible){const K=A(L,ee,D,C);L.onBeforeShadow(i,L,F,q,ne,K,null),i.renderBufferDirect(q,null,ne,K,L,null),L.onAfterShadow(i,L,F,q,ne,K,null)}}const j=L.children;for(let ne=0,ee=j.length;ne<ee;ne++)N(j[ne],F,q,D,C)}function P(L){L.target.removeEventListener("dispose",P);for(const q in p){const D=p[q],C=L.target.uuid;C in D&&(D[C].dispose(),delete D[C])}}}const AR={[Nd]:_u,[Od]:Id,[Pd]:Fd,[js]:Bd,[_u]:Nd,[Id]:Od,[Fd]:Pd,[Bd]:js};function RR(i,e){function t(){let k=!1;const Le=new un;let Ce=null;const we=new un(0,0,0,0);return{setMask:function(Te){Ce!==Te&&!k&&(i.colorMask(Te,Te,Te,Te),Ce=Te)},setLocked:function(Te){k=Te},setClear:function(Te,ye,Ve,st,Bt){Bt===!0&&(Te*=st,ye*=st,Ve*=st),Le.set(Te,ye,Ve,st),we.equals(Le)===!1&&(i.clearColor(Te,ye,Ve,st),we.copy(Le))},reset:function(){k=!1,Ce=null,we.set(-1,0,0,0)}}}function r(){let k=!1,Le=!1,Ce=null,we=null,Te=null;return{setReversed:function(ye){if(Le!==ye){const Ve=e.get("EXT_clip_control");ye?Ve.clipControlEXT(Ve.LOWER_LEFT_EXT,Ve.ZERO_TO_ONE_EXT):Ve.clipControlEXT(Ve.LOWER_LEFT_EXT,Ve.NEGATIVE_ONE_TO_ONE_EXT),Le=ye;const st=Te;Te=null,this.setClear(st)}},getReversed:function(){return Le},setTest:function(ye){ye?ge(i.DEPTH_TEST):be(i.DEPTH_TEST)},setMask:function(ye){Ce!==ye&&!k&&(i.depthMask(ye),Ce=ye)},setFunc:function(ye){if(Le&&(ye=AR[ye]),we!==ye){switch(ye){case Nd:i.depthFunc(i.NEVER);break;case _u:i.depthFunc(i.ALWAYS);break;case Od:i.depthFunc(i.LESS);break;case js:i.depthFunc(i.LEQUAL);break;case Pd:i.depthFunc(i.EQUAL);break;case Bd:i.depthFunc(i.GEQUAL);break;case Id:i.depthFunc(i.GREATER);break;case Fd:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}we=ye}},setLocked:function(ye){k=ye},setClear:function(ye){Te!==ye&&(Le&&(ye=1-ye),i.clearDepth(ye),Te=ye)},reset:function(){k=!1,Ce=null,we=null,Te=null,Le=!1}}}function o(){let k=!1,Le=null,Ce=null,we=null,Te=null,ye=null,Ve=null,st=null,Bt=null;return{setTest:function(Ut){k||(Ut?ge(i.STENCIL_TEST):be(i.STENCIL_TEST))},setMask:function(Ut){Le!==Ut&&!k&&(i.stencilMask(Ut),Le=Ut)},setFunc:function(Ut,fi,fn){(Ce!==Ut||we!==fi||Te!==fn)&&(i.stencilFunc(Ut,fi,fn),Ce=Ut,we=fi,Te=fn)},setOp:function(Ut,fi,fn){(ye!==Ut||Ve!==fi||st!==fn)&&(i.stencilOp(Ut,fi,fn),ye=Ut,Ve=fi,st=fn)},setLocked:function(Ut){k=Ut},setClear:function(Ut){Bt!==Ut&&(i.clearStencil(Ut),Bt=Ut)},reset:function(){k=!1,Le=null,Ce=null,we=null,Te=null,ye=null,Ve=null,st=null,Bt=null}}}const l=new t,u=new r,f=new o,d=new WeakMap,p=new WeakMap;let g={},x={},v=new WeakMap,y=[],b=null,M=!1,S=null,_=null,w=null,A=null,N=null,P=null,L=null,F=new Pt(0,0,0),q=0,D=!1,C=null,H=null,j=null,ne=null,ee=null;const K=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,W=0;const Y=i.getParameter(i.VERSION);Y.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(Y)[1]),I=W>=1):Y.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),I=W>=2);let pe=null,O={};const re=i.getParameter(i.SCISSOR_BOX),Se=i.getParameter(i.VIEWPORT),Me=new un().fromArray(re),De=new un().fromArray(Se);function We(k,Le,Ce,we){const Te=new Uint8Array(4),ye=i.createTexture();i.bindTexture(k,ye),i.texParameteri(k,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(k,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ve=0;Ve<Ce;Ve++)k===i.TEXTURE_3D||k===i.TEXTURE_2D_ARRAY?i.texImage3D(Le,0,i.RGBA,1,1,we,0,i.RGBA,i.UNSIGNED_BYTE,Te):i.texImage2D(Le+Ve,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Te);return ye}const ae={};ae[i.TEXTURE_2D]=We(i.TEXTURE_2D,i.TEXTURE_2D,1),ae[i.TEXTURE_CUBE_MAP]=We(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ae[i.TEXTURE_2D_ARRAY]=We(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ae[i.TEXTURE_3D]=We(i.TEXTURE_3D,i.TEXTURE_3D,1,1),l.setClear(0,0,0,1),u.setClear(1),f.setClear(0),ge(i.DEPTH_TEST),u.setFunc(js),He(!1),Fe(Dx),ge(i.CULL_FACE),Rt(Li);function ge(k){g[k]!==!0&&(i.enable(k),g[k]=!0)}function be(k){g[k]!==!1&&(i.disable(k),g[k]=!1)}function qe(k,Le){return x[k]!==Le?(i.bindFramebuffer(k,Le),x[k]=Le,k===i.DRAW_FRAMEBUFFER&&(x[i.FRAMEBUFFER]=Le),k===i.FRAMEBUFFER&&(x[i.DRAW_FRAMEBUFFER]=Le),!0):!1}function Xe(k,Le){let Ce=y,we=!1;if(k){Ce=v.get(Le),Ce===void 0&&(Ce=[],v.set(Le,Ce));const Te=k.textures;if(Ce.length!==Te.length||Ce[0]!==i.COLOR_ATTACHMENT0){for(let ye=0,Ve=Te.length;ye<Ve;ye++)Ce[ye]=i.COLOR_ATTACHMENT0+ye;Ce.length=Te.length,we=!0}}else Ce[0]!==i.BACK&&(Ce[0]=i.BACK,we=!0);we&&i.drawBuffers(Ce)}function ct(k){return b!==k?(i.useProgram(k),b=k,!0):!1}const Qt={[Vr]:i.FUNC_ADD,[OM]:i.FUNC_SUBTRACT,[PM]:i.FUNC_REVERSE_SUBTRACT};Qt[BM]=i.MIN,Qt[IM]=i.MAX;const ut={[FM]:i.ZERO,[zM]:i.ONE,[HM]:i.SRC_COLOR,[Ud]:i.SRC_ALPHA,[qM]:i.SRC_ALPHA_SATURATE,[XM]:i.DST_COLOR,[VM]:i.DST_ALPHA,[GM]:i.ONE_MINUS_SRC_COLOR,[Ld]:i.ONE_MINUS_SRC_ALPHA,[WM]:i.ONE_MINUS_DST_COLOR,[kM]:i.ONE_MINUS_DST_ALPHA,[jM]:i.CONSTANT_COLOR,[YM]:i.ONE_MINUS_CONSTANT_COLOR,[ZM]:i.CONSTANT_ALPHA,[KM]:i.ONE_MINUS_CONSTANT_ALPHA};function Rt(k,Le,Ce,we,Te,ye,Ve,st,Bt,Ut){if(k===Li){M===!0&&(be(i.BLEND),M=!1);return}if(M===!1&&(ge(i.BLEND),M=!0),k!==NM){if(k!==S||Ut!==D){if((_!==Vr||N!==Vr)&&(i.blendEquation(i.FUNC_ADD),_=Vr,N=Vr),Ut)switch(k){case Ws:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ux:i.blendFunc(i.ONE,i.ONE);break;case Lx:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Nx:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:cn("WebGLState: Invalid blending: ",k);break}else switch(k){case Ws:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ux:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Lx:cn("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Nx:cn("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:cn("WebGLState: Invalid blending: ",k);break}w=null,A=null,P=null,L=null,F.set(0,0,0),q=0,S=k,D=Ut}return}Te=Te||Le,ye=ye||Ce,Ve=Ve||we,(Le!==_||Te!==N)&&(i.blendEquationSeparate(Qt[Le],Qt[Te]),_=Le,N=Te),(Ce!==w||we!==A||ye!==P||Ve!==L)&&(i.blendFuncSeparate(ut[Ce],ut[we],ut[ye],ut[Ve]),w=Ce,A=we,P=ye,L=Ve),(st.equals(F)===!1||Bt!==q)&&(i.blendColor(st.r,st.g,st.b,Bt),F.copy(st),q=Bt),S=k,D=!1}function V(k,Le){k.side===si?be(i.CULL_FACE):ge(i.CULL_FACE);let Ce=k.side===Cn;Le&&(Ce=!Ce),He(Ce),k.blending===Ws&&k.transparent===!1?Rt(Li):Rt(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),u.setFunc(k.depthFunc),u.setTest(k.depthTest),u.setMask(k.depthWrite),l.setMask(k.colorWrite);const we=k.stencilWrite;f.setTest(we),we&&(f.setMask(k.stencilWriteMask),f.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),f.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),Pe(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?ge(i.SAMPLE_ALPHA_TO_COVERAGE):be(i.SAMPLE_ALPHA_TO_COVERAGE)}function He(k){C!==k&&(k?i.frontFace(i.CW):i.frontFace(i.CCW),C=k)}function Fe(k){k!==DM?(ge(i.CULL_FACE),k!==H&&(k===Dx?i.cullFace(i.BACK):k===UM?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):be(i.CULL_FACE),H=k}function gt(k){k!==j&&(I&&i.lineWidth(k),j=k)}function Pe(k,Le,Ce){k?(ge(i.POLYGON_OFFSET_FILL),(ne!==Le||ee!==Ce)&&(i.polygonOffset(Le,Ce),ne=Le,ee=Ce)):be(i.POLYGON_OFFSET_FILL)}function Ot(k){k?ge(i.SCISSOR_TEST):be(i.SCISSOR_TEST)}function je(k){k===void 0&&(k=i.TEXTURE0+K-1),pe!==k&&(i.activeTexture(k),pe=k)}function lt(k,Le,Ce){Ce===void 0&&(pe===null?Ce=i.TEXTURE0+K-1:Ce=pe);let we=O[Ce];we===void 0&&(we={type:void 0,texture:void 0},O[Ce]=we),(we.type!==k||we.texture!==Le)&&(pe!==Ce&&(i.activeTexture(Ce),pe=Ce),i.bindTexture(k,Le||ae[k]),we.type=k,we.texture=Le)}function B(){const k=O[pe];k!==void 0&&k.type!==void 0&&(i.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function T(){try{i.compressedTexImage2D(...arguments)}catch(k){k("WebGLState:",k)}}function ie(){try{i.compressedTexImage3D(...arguments)}catch(k){k("WebGLState:",k)}}function me(){try{i.texSubImage2D(...arguments)}catch(k){k("WebGLState:",k)}}function ve(){try{i.texSubImage3D(...arguments)}catch(k){k("WebGLState:",k)}}function fe(){try{i.compressedTexSubImage2D(...arguments)}catch(k){k("WebGLState:",k)}}function Ie(){try{i.compressedTexSubImage3D(...arguments)}catch(k){k("WebGLState:",k)}}function Ne(){try{i.texStorage2D(...arguments)}catch(k){k("WebGLState:",k)}}function tt(){try{i.texStorage3D(...arguments)}catch(k){k("WebGLState:",k)}}function Ye(){try{i.texImage2D(...arguments)}catch(k){k("WebGLState:",k)}}function Ee(){try{i.texImage3D(...arguments)}catch(k){k("WebGLState:",k)}}function Re(k){Me.equals(k)===!1&&(i.scissor(k.x,k.y,k.z,k.w),Me.copy(k))}function Qe(k){De.equals(k)===!1&&(i.viewport(k.x,k.y,k.z,k.w),De.copy(k))}function et(k,Le){let Ce=p.get(Le);Ce===void 0&&(Ce=new WeakMap,p.set(Le,Ce));let we=Ce.get(k);we===void 0&&(we=i.getUniformBlockIndex(Le,k.name),Ce.set(k,we))}function Be(k,Le){const we=p.get(Le).get(k);d.get(Le)!==we&&(i.uniformBlockBinding(Le,we,k.__bindingPointIndex),d.set(Le,we))}function rt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),u.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),g={},pe=null,O={},x={},v=new WeakMap,y=[],b=null,M=!1,S=null,_=null,w=null,A=null,N=null,P=null,L=null,F=new Pt(0,0,0),q=0,D=!1,C=null,H=null,j=null,ne=null,ee=null,Me.set(0,0,i.canvas.width,i.canvas.height),De.set(0,0,i.canvas.width,i.canvas.height),l.reset(),u.reset(),f.reset()}return{buffers:{color:l,depth:u,stencil:f},enable:ge,disable:be,bindFramebuffer:qe,drawBuffers:Xe,useProgram:ct,setBlending:Rt,setMaterial:V,setFlipSided:He,setCullFace:Fe,setLineWidth:gt,setPolygonOffset:Pe,setScissorTest:Ot,activeTexture:je,bindTexture:lt,unbindTexture:B,compressedTexImage2D:T,compressedTexImage3D:ie,texImage2D:Ye,texImage3D:Ee,updateUBOMapping:et,uniformBlockBinding:Be,texStorage2D:Ne,texStorage3D:tt,texSubImage2D:me,texSubImage3D:ve,compressedTexSubImage2D:fe,compressedTexSubImage3D:Ie,scissor:Re,viewport:Qe,reset:rt}}function wR(i,e,t,r,o,l,u){const f=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,d=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new _t,g=new WeakMap;let x;const v=new WeakMap;let y=!1;try{y=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(B,T){return y?new OffscreenCanvas(B,T):bu("canvas")}function M(B,T,ie){let me=1;const ve=lt(B);if((ve.width>ie||ve.height>ie)&&(me=ie/Math.max(ve.width,ve.height)),me<1)if(typeof HTMLImageElement<"u"&&B instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&B instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&B instanceof ImageBitmap||typeof VideoFrame<"u"&&B instanceof VideoFrame){const fe=Math.floor(me*ve.width),Ie=Math.floor(me*ve.height);x===void 0&&(x=b(fe,Ie));const Ne=T?b(fe,Ie):x;return Ne.width=fe,Ne.height=Ie,Ne.getContext("2d").drawImage(B,0,0,fe,Ie),ft("WebGLRenderer: Texture has been resized from ("+ve.width+"x"+ve.height+") to ("+fe+"x"+Ie+")."),Ne}else return"data"in B&&ft("WebGLRenderer: Image in DataTexture is too big ("+ve.width+"x"+ve.height+")."),B;return B}function S(B){return B.generateMipmaps}function _(B){i.generateMipmap(B)}function w(B){return B.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:B.isWebGL3DRenderTarget?i.TEXTURE_3D:B.isWebGLArrayRenderTarget||B.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function A(B,T,ie,me,ve=!1){if(B!==null){if(i[B]!==void 0)return i[B];ft("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+B+"'")}let fe=T;if(T===i.RED&&(ie===i.FLOAT&&(fe=i.R32F),ie===i.HALF_FLOAT&&(fe=i.R16F),ie===i.UNSIGNED_BYTE&&(fe=i.R8)),T===i.RED_INTEGER&&(ie===i.UNSIGNED_BYTE&&(fe=i.R8UI),ie===i.UNSIGNED_SHORT&&(fe=i.R16UI),ie===i.UNSIGNED_INT&&(fe=i.R32UI),ie===i.BYTE&&(fe=i.R8I),ie===i.SHORT&&(fe=i.R16I),ie===i.INT&&(fe=i.R32I)),T===i.RG&&(ie===i.FLOAT&&(fe=i.RG32F),ie===i.HALF_FLOAT&&(fe=i.RG16F),ie===i.UNSIGNED_BYTE&&(fe=i.RG8)),T===i.RG_INTEGER&&(ie===i.UNSIGNED_BYTE&&(fe=i.RG8UI),ie===i.UNSIGNED_SHORT&&(fe=i.RG16UI),ie===i.UNSIGNED_INT&&(fe=i.RG32UI),ie===i.BYTE&&(fe=i.RG8I),ie===i.SHORT&&(fe=i.RG16I),ie===i.INT&&(fe=i.RG32I)),T===i.RGB_INTEGER&&(ie===i.UNSIGNED_BYTE&&(fe=i.RGB8UI),ie===i.UNSIGNED_SHORT&&(fe=i.RGB16UI),ie===i.UNSIGNED_INT&&(fe=i.RGB32UI),ie===i.BYTE&&(fe=i.RGB8I),ie===i.SHORT&&(fe=i.RGB16I),ie===i.INT&&(fe=i.RGB32I)),T===i.RGBA_INTEGER&&(ie===i.UNSIGNED_BYTE&&(fe=i.RGBA8UI),ie===i.UNSIGNED_SHORT&&(fe=i.RGBA16UI),ie===i.UNSIGNED_INT&&(fe=i.RGBA32UI),ie===i.BYTE&&(fe=i.RGBA8I),ie===i.SHORT&&(fe=i.RGBA16I),ie===i.INT&&(fe=i.RGBA32I)),T===i.RGB&&(ie===i.UNSIGNED_INT_5_9_9_9_REV&&(fe=i.RGB9_E5),ie===i.UNSIGNED_INT_10F_11F_11F_REV&&(fe=i.R11F_G11F_B10F)),T===i.RGBA){const Ie=ve?yu:Ct.getTransfer(me);ie===i.FLOAT&&(fe=i.RGBA32F),ie===i.HALF_FLOAT&&(fe=i.RGBA16F),ie===i.UNSIGNED_BYTE&&(fe=Ie===kt?i.SRGB8_ALPHA8:i.RGBA8),ie===i.UNSIGNED_SHORT_4_4_4_4&&(fe=i.RGBA4),ie===i.UNSIGNED_SHORT_5_5_5_1&&(fe=i.RGB5_A1)}return(fe===i.R16F||fe===i.R32F||fe===i.RG16F||fe===i.RG32F||fe===i.RGBA16F||fe===i.RGBA32F)&&e.get("EXT_color_buffer_float"),fe}function N(B,T){let ie;return B?T===null||T===fr||T===Ks?ie=i.DEPTH24_STENCIL8:T===ya?ie=i.DEPTH32F_STENCIL8:T===pl&&(ie=i.DEPTH24_STENCIL8,ft("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):T===null||T===fr||T===Ks?ie=i.DEPTH_COMPONENT24:T===ya?ie=i.DEPTH_COMPONENT32F:T===pl&&(ie=i.DEPTH_COMPONENT16),ie}function P(B,T){return S(B)===!0||B.isFramebufferTexture&&B.minFilter!==oi&&B.minFilter!==Dn?Math.log2(Math.max(T.width,T.height))+1:B.mipmaps!==void 0&&B.mipmaps.length>0?B.mipmaps.length:B.isCompressedTexture&&Array.isArray(B.image)?T.mipmaps.length:1}function L(B){const T=B.target;T.removeEventListener("dispose",L),q(T),T.isVideoTexture&&g.delete(T)}function F(B){const T=B.target;T.removeEventListener("dispose",F),C(T)}function q(B){const T=r.get(B);if(T.__webglInit===void 0)return;const ie=B.source,me=v.get(ie);if(me){const ve=me[T.__cacheKey];ve.usedTimes--,ve.usedTimes===0&&D(B),Object.keys(me).length===0&&v.delete(ie)}r.remove(B)}function D(B){const T=r.get(B);i.deleteTexture(T.__webglTexture);const ie=B.source,me=v.get(ie);delete me[T.__cacheKey],u.memory.textures--}function C(B){const T=r.get(B);if(B.depthTexture&&(B.depthTexture.dispose(),r.remove(B.depthTexture)),B.isWebGLCubeRenderTarget)for(let me=0;me<6;me++){if(Array.isArray(T.__webglFramebuffer[me]))for(let ve=0;ve<T.__webglFramebuffer[me].length;ve++)i.deleteFramebuffer(T.__webglFramebuffer[me][ve]);else i.deleteFramebuffer(T.__webglFramebuffer[me]);T.__webglDepthbuffer&&i.deleteRenderbuffer(T.__webglDepthbuffer[me])}else{if(Array.isArray(T.__webglFramebuffer))for(let me=0;me<T.__webglFramebuffer.length;me++)i.deleteFramebuffer(T.__webglFramebuffer[me]);else i.deleteFramebuffer(T.__webglFramebuffer);if(T.__webglDepthbuffer&&i.deleteRenderbuffer(T.__webglDepthbuffer),T.__webglMultisampledFramebuffer&&i.deleteFramebuffer(T.__webglMultisampledFramebuffer),T.__webglColorRenderbuffer)for(let me=0;me<T.__webglColorRenderbuffer.length;me++)T.__webglColorRenderbuffer[me]&&i.deleteRenderbuffer(T.__webglColorRenderbuffer[me]);T.__webglDepthRenderbuffer&&i.deleteRenderbuffer(T.__webglDepthRenderbuffer)}const ie=B.textures;for(let me=0,ve=ie.length;me<ve;me++){const fe=r.get(ie[me]);fe.__webglTexture&&(i.deleteTexture(fe.__webglTexture),u.memory.textures--),r.remove(ie[me])}r.remove(B)}let H=0;function j(){H=0}function ne(){const B=H;return B>=o.maxTextures&&ft("WebGLTextures: Trying to use "+B+" texture units while this GPU supports only "+o.maxTextures),H+=1,B}function ee(B){const T=[];return T.push(B.wrapS),T.push(B.wrapT),T.push(B.wrapR||0),T.push(B.magFilter),T.push(B.minFilter),T.push(B.anisotropy),T.push(B.internalFormat),T.push(B.format),T.push(B.type),T.push(B.generateMipmaps),T.push(B.premultiplyAlpha),T.push(B.flipY),T.push(B.unpackAlignment),T.push(B.colorSpace),T.join()}function K(B,T){const ie=r.get(B);if(B.isVideoTexture&&Ot(B),B.isRenderTargetTexture===!1&&B.isExternalTexture!==!0&&B.version>0&&ie.__version!==B.version){const me=B.image;if(me===null)ft("WebGLRenderer: Texture marked for update but no image data found.");else if(me.complete===!1)ft("WebGLRenderer: Texture marked for update but image is incomplete");else{ae(ie,B,T);return}}else B.isExternalTexture&&(ie.__webglTexture=B.sourceTexture?B.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,ie.__webglTexture,i.TEXTURE0+T)}function I(B,T){const ie=r.get(B);if(B.isRenderTargetTexture===!1&&B.version>0&&ie.__version!==B.version){ae(ie,B,T);return}else B.isExternalTexture&&(ie.__webglTexture=B.sourceTexture?B.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,ie.__webglTexture,i.TEXTURE0+T)}function W(B,T){const ie=r.get(B);if(B.isRenderTargetTexture===!1&&B.version>0&&ie.__version!==B.version){ae(ie,B,T);return}t.bindTexture(i.TEXTURE_3D,ie.__webglTexture,i.TEXTURE0+T)}function Y(B,T){const ie=r.get(B);if(B.version>0&&ie.__version!==B.version){ge(ie,B,T);return}t.bindTexture(i.TEXTURE_CUBE_MAP,ie.__webglTexture,i.TEXTURE0+T)}const pe={[Gd]:i.REPEAT,[_a]:i.CLAMP_TO_EDGE,[Vd]:i.MIRRORED_REPEAT},O={[oi]:i.NEAREST,[sE]:i.NEAREST_MIPMAP_NEAREST,[Bc]:i.NEAREST_MIPMAP_LINEAR,[Dn]:i.LINEAR,[Vh]:i.LINEAR_MIPMAP_NEAREST,[Xr]:i.LINEAR_MIPMAP_LINEAR},re={[uE]:i.NEVER,[gE]:i.ALWAYS,[fE]:i.LESS,[D_]:i.LEQUAL,[hE]:i.EQUAL,[mE]:i.GEQUAL,[dE]:i.GREATER,[pE]:i.NOTEQUAL};function Se(B,T){if(T.type===ya&&e.has("OES_texture_float_linear")===!1&&(T.magFilter===Dn||T.magFilter===Vh||T.magFilter===Bc||T.magFilter===Xr||T.minFilter===Dn||T.minFilter===Vh||T.minFilter===Bc||T.minFilter===Xr)&&ft("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(B,i.TEXTURE_WRAP_S,pe[T.wrapS]),i.texParameteri(B,i.TEXTURE_WRAP_T,pe[T.wrapT]),(B===i.TEXTURE_3D||B===i.TEXTURE_2D_ARRAY)&&i.texParameteri(B,i.TEXTURE_WRAP_R,pe[T.wrapR]),i.texParameteri(B,i.TEXTURE_MAG_FILTER,O[T.magFilter]),i.texParameteri(B,i.TEXTURE_MIN_FILTER,O[T.minFilter]),T.compareFunction&&(i.texParameteri(B,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(B,i.TEXTURE_COMPARE_FUNC,re[T.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(T.magFilter===oi||T.minFilter!==Bc&&T.minFilter!==Xr||T.type===ya&&e.has("OES_texture_float_linear")===!1)return;if(T.anisotropy>1||r.get(T).__currentAnisotropy){const ie=e.get("EXT_texture_filter_anisotropic");i.texParameterf(B,ie.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(T.anisotropy,o.getMaxAnisotropy())),r.get(T).__currentAnisotropy=T.anisotropy}}}function Me(B,T){let ie=!1;B.__webglInit===void 0&&(B.__webglInit=!0,T.addEventListener("dispose",L));const me=T.source;let ve=v.get(me);ve===void 0&&(ve={},v.set(me,ve));const fe=ee(T);if(fe!==B.__cacheKey){ve[fe]===void 0&&(ve[fe]={texture:i.createTexture(),usedTimes:0},u.memory.textures++,ie=!0),ve[fe].usedTimes++;const Ie=ve[B.__cacheKey];Ie!==void 0&&(ve[B.__cacheKey].usedTimes--,Ie.usedTimes===0&&D(T)),B.__cacheKey=fe,B.__webglTexture=ve[fe].texture}return ie}function De(B,T,ie){return Math.floor(Math.floor(B/ie)/T)}function We(B,T,ie,me){const fe=B.updateRanges;if(fe.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,T.width,T.height,ie,me,T.data);else{fe.sort((Ee,Re)=>Ee.start-Re.start);let Ie=0;for(let Ee=1;Ee<fe.length;Ee++){const Re=fe[Ie],Qe=fe[Ee],et=Re.start+Re.count,Be=De(Qe.start,T.width,4),rt=De(Re.start,T.width,4);Qe.start<=et+1&&Be===rt&&De(Qe.start+Qe.count-1,T.width,4)===Be?Re.count=Math.max(Re.count,Qe.start+Qe.count-Re.start):(++Ie,fe[Ie]=Qe)}fe.length=Ie+1;const Ne=i.getParameter(i.UNPACK_ROW_LENGTH),tt=i.getParameter(i.UNPACK_SKIP_PIXELS),Ye=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,T.width);for(let Ee=0,Re=fe.length;Ee<Re;Ee++){const Qe=fe[Ee],et=Math.floor(Qe.start/4),Be=Math.ceil(Qe.count/4),rt=et%T.width,k=Math.floor(et/T.width),Le=Be,Ce=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,rt),i.pixelStorei(i.UNPACK_SKIP_ROWS,k),t.texSubImage2D(i.TEXTURE_2D,0,rt,k,Le,Ce,ie,me,T.data)}B.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,Ne),i.pixelStorei(i.UNPACK_SKIP_PIXELS,tt),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ye)}}function ae(B,T,ie){let me=i.TEXTURE_2D;(T.isDataArrayTexture||T.isCompressedArrayTexture)&&(me=i.TEXTURE_2D_ARRAY),T.isData3DTexture&&(me=i.TEXTURE_3D);const ve=Me(B,T),fe=T.source;t.bindTexture(me,B.__webglTexture,i.TEXTURE0+ie);const Ie=r.get(fe);if(fe.version!==Ie.__version||ve===!0){t.activeTexture(i.TEXTURE0+ie);const Ne=Ct.getPrimaries(Ct.workingColorSpace),tt=T.colorSpace===Xi?null:Ct.getPrimaries(T.colorSpace),Ye=T.colorSpace===Xi||Ne===tt?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,T.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,T.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ye);let Ee=M(T.image,!1,o.maxTextureSize);Ee=je(T,Ee);const Re=l.convert(T.format,T.colorSpace),Qe=l.convert(T.type);let et=A(T.internalFormat,Re,Qe,T.colorSpace,T.isVideoTexture);Se(me,T);let Be;const rt=T.mipmaps,k=T.isVideoTexture!==!0,Le=Ie.__version===void 0||ve===!0,Ce=fe.dataReady,we=P(T,Ee);if(T.isDepthTexture)et=N(T.format===Qs,T.type),Le&&(k?t.texStorage2D(i.TEXTURE_2D,1,et,Ee.width,Ee.height):t.texImage2D(i.TEXTURE_2D,0,et,Ee.width,Ee.height,0,Re,Qe,null));else if(T.isDataTexture)if(rt.length>0){k&&Le&&t.texStorage2D(i.TEXTURE_2D,we,et,rt[0].width,rt[0].height);for(let Te=0,ye=rt.length;Te<ye;Te++)Be=rt[Te],k?Ce&&t.texSubImage2D(i.TEXTURE_2D,Te,0,0,Be.width,Be.height,Re,Qe,Be.data):t.texImage2D(i.TEXTURE_2D,Te,et,Be.width,Be.height,0,Re,Qe,Be.data);T.generateMipmaps=!1}else k?(Le&&t.texStorage2D(i.TEXTURE_2D,we,et,Ee.width,Ee.height),Ce&&We(T,Ee,Re,Qe)):t.texImage2D(i.TEXTURE_2D,0,et,Ee.width,Ee.height,0,Re,Qe,Ee.data);else if(T.isCompressedTexture)if(T.isCompressedArrayTexture){k&&Le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,we,et,rt[0].width,rt[0].height,Ee.depth);for(let Te=0,ye=rt.length;Te<ye;Te++)if(Be=rt[Te],T.format!==Ui)if(Re!==null)if(k){if(Ce)if(T.layerUpdates.size>0){const Ve=ev(Be.width,Be.height,T.format,T.type);for(const st of T.layerUpdates){const Bt=Be.data.subarray(st*Ve/Be.data.BYTES_PER_ELEMENT,(st+1)*Ve/Be.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Te,0,0,st,Be.width,Be.height,1,Re,Bt)}T.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Te,0,0,0,Be.width,Be.height,Ee.depth,Re,Be.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Te,et,Be.width,Be.height,Ee.depth,0,Be.data,0,0);else ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else k?Ce&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Te,0,0,0,Be.width,Be.height,Ee.depth,Re,Qe,Be.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Te,et,Be.width,Be.height,Ee.depth,0,Re,Qe,Be.data)}else{k&&Le&&t.texStorage2D(i.TEXTURE_2D,we,et,rt[0].width,rt[0].height);for(let Te=0,ye=rt.length;Te<ye;Te++)Be=rt[Te],T.format!==Ui?Re!==null?k?Ce&&t.compressedTexSubImage2D(i.TEXTURE_2D,Te,0,0,Be.width,Be.height,Re,Be.data):t.compressedTexImage2D(i.TEXTURE_2D,Te,et,Be.width,Be.height,0,Be.data):ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):k?Ce&&t.texSubImage2D(i.TEXTURE_2D,Te,0,0,Be.width,Be.height,Re,Qe,Be.data):t.texImage2D(i.TEXTURE_2D,Te,et,Be.width,Be.height,0,Re,Qe,Be.data)}else if(T.isDataArrayTexture)if(k){if(Le&&t.texStorage3D(i.TEXTURE_2D_ARRAY,we,et,Ee.width,Ee.height,Ee.depth),Ce)if(T.layerUpdates.size>0){const Te=ev(Ee.width,Ee.height,T.format,T.type);for(const ye of T.layerUpdates){const Ve=Ee.data.subarray(ye*Te/Ee.data.BYTES_PER_ELEMENT,(ye+1)*Te/Ee.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ye,Ee.width,Ee.height,1,Re,Qe,Ve)}T.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,Ee.width,Ee.height,Ee.depth,Re,Qe,Ee.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,et,Ee.width,Ee.height,Ee.depth,0,Re,Qe,Ee.data);else if(T.isData3DTexture)k?(Le&&t.texStorage3D(i.TEXTURE_3D,we,et,Ee.width,Ee.height,Ee.depth),Ce&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,Ee.width,Ee.height,Ee.depth,Re,Qe,Ee.data)):t.texImage3D(i.TEXTURE_3D,0,et,Ee.width,Ee.height,Ee.depth,0,Re,Qe,Ee.data);else if(T.isFramebufferTexture){if(Le)if(k)t.texStorage2D(i.TEXTURE_2D,we,et,Ee.width,Ee.height);else{let Te=Ee.width,ye=Ee.height;for(let Ve=0;Ve<we;Ve++)t.texImage2D(i.TEXTURE_2D,Ve,et,Te,ye,0,Re,Qe,null),Te>>=1,ye>>=1}}else if(rt.length>0){if(k&&Le){const Te=lt(rt[0]);t.texStorage2D(i.TEXTURE_2D,we,et,Te.width,Te.height)}for(let Te=0,ye=rt.length;Te<ye;Te++)Be=rt[Te],k?Ce&&t.texSubImage2D(i.TEXTURE_2D,Te,0,0,Re,Qe,Be):t.texImage2D(i.TEXTURE_2D,Te,et,Re,Qe,Be);T.generateMipmaps=!1}else if(k){if(Le){const Te=lt(Ee);t.texStorage2D(i.TEXTURE_2D,we,et,Te.width,Te.height)}Ce&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,Re,Qe,Ee)}else t.texImage2D(i.TEXTURE_2D,0,et,Re,Qe,Ee);S(T)&&_(me),Ie.__version=fe.version,T.onUpdate&&T.onUpdate(T)}B.__version=T.version}function ge(B,T,ie){if(T.image.length!==6)return;const me=Me(B,T),ve=T.source;t.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+ie);const fe=r.get(ve);if(ve.version!==fe.__version||me===!0){t.activeTexture(i.TEXTURE0+ie);const Ie=Ct.getPrimaries(Ct.workingColorSpace),Ne=T.colorSpace===Xi?null:Ct.getPrimaries(T.colorSpace),tt=T.colorSpace===Xi||Ie===Ne?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,T.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,T.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,T.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,tt);const Ye=T.isCompressedTexture||T.image[0].isCompressedTexture,Ee=T.image[0]&&T.image[0].isDataTexture,Re=[];for(let ye=0;ye<6;ye++)!Ye&&!Ee?Re[ye]=M(T.image[ye],!0,o.maxCubemapSize):Re[ye]=Ee?T.image[ye].image:T.image[ye],Re[ye]=je(T,Re[ye]);const Qe=Re[0],et=l.convert(T.format,T.colorSpace),Be=l.convert(T.type),rt=A(T.internalFormat,et,Be,T.colorSpace),k=T.isVideoTexture!==!0,Le=fe.__version===void 0||me===!0,Ce=ve.dataReady;let we=P(T,Qe);Se(i.TEXTURE_CUBE_MAP,T);let Te;if(Ye){k&&Le&&t.texStorage2D(i.TEXTURE_CUBE_MAP,we,rt,Qe.width,Qe.height);for(let ye=0;ye<6;ye++){Te=Re[ye].mipmaps;for(let Ve=0;Ve<Te.length;Ve++){const st=Te[Ve];T.format!==Ui?et!==null?k?Ce&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ve,0,0,st.width,st.height,et,st.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ve,rt,st.width,st.height,0,st.data):ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?Ce&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ve,0,0,st.width,st.height,et,Be,st.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ve,rt,st.width,st.height,0,et,Be,st.data)}}}else{if(Te=T.mipmaps,k&&Le){Te.length>0&&we++;const ye=lt(Re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,we,rt,ye.width,ye.height)}for(let ye=0;ye<6;ye++)if(Ee){k?Ce&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,0,0,Re[ye].width,Re[ye].height,et,Be,Re[ye].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,rt,Re[ye].width,Re[ye].height,0,et,Be,Re[ye].data);for(let Ve=0;Ve<Te.length;Ve++){const Bt=Te[Ve].image[ye].image;k?Ce&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ve+1,0,0,Bt.width,Bt.height,et,Be,Bt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ve+1,rt,Bt.width,Bt.height,0,et,Be,Bt.data)}}else{k?Ce&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,0,0,et,Be,Re[ye]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0,rt,et,Be,Re[ye]);for(let Ve=0;Ve<Te.length;Ve++){const st=Te[Ve];k?Ce&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ve+1,0,0,et,Be,st.image[ye]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ve+1,rt,et,Be,st.image[ye])}}}S(T)&&_(i.TEXTURE_CUBE_MAP),fe.__version=ve.version,T.onUpdate&&T.onUpdate(T)}B.__version=T.version}function be(B,T,ie,me,ve,fe){const Ie=l.convert(ie.format,ie.colorSpace),Ne=l.convert(ie.type),tt=A(ie.internalFormat,Ie,Ne,ie.colorSpace),Ye=r.get(T),Ee=r.get(ie);if(Ee.__renderTarget=T,!Ye.__hasExternalTextures){const Re=Math.max(1,T.width>>fe),Qe=Math.max(1,T.height>>fe);ve===i.TEXTURE_3D||ve===i.TEXTURE_2D_ARRAY?t.texImage3D(ve,fe,tt,Re,Qe,T.depth,0,Ie,Ne,null):t.texImage2D(ve,fe,tt,Re,Qe,0,Ie,Ne,null)}t.bindFramebuffer(i.FRAMEBUFFER,B),Pe(T)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,me,ve,Ee.__webglTexture,0,gt(T)):(ve===i.TEXTURE_2D||ve>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ve<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,me,ve,Ee.__webglTexture,fe),t.bindFramebuffer(i.FRAMEBUFFER,null)}function qe(B,T,ie){if(i.bindRenderbuffer(i.RENDERBUFFER,B),T.depthBuffer){const me=T.depthTexture,ve=me&&me.isDepthTexture?me.type:null,fe=N(T.stencilBuffer,ve),Ie=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ne=gt(T);Pe(T)?f.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ne,fe,T.width,T.height):ie?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ne,fe,T.width,T.height):i.renderbufferStorage(i.RENDERBUFFER,fe,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Ie,i.RENDERBUFFER,B)}else{const me=T.textures;for(let ve=0;ve<me.length;ve++){const fe=me[ve],Ie=l.convert(fe.format,fe.colorSpace),Ne=l.convert(fe.type),tt=A(fe.internalFormat,Ie,Ne,fe.colorSpace),Ye=gt(T);ie&&Pe(T)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ye,tt,T.width,T.height):Pe(T)?f.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ye,tt,T.width,T.height):i.renderbufferStorage(i.RENDERBUFFER,tt,T.width,T.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Xe(B,T){if(T&&T.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,B),!(T.depthTexture&&T.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const me=r.get(T.depthTexture);me.__renderTarget=T,(!me.__webglTexture||T.depthTexture.image.width!==T.width||T.depthTexture.image.height!==T.height)&&(T.depthTexture.image.width=T.width,T.depthTexture.image.height=T.height,T.depthTexture.needsUpdate=!0),K(T.depthTexture,0);const ve=me.__webglTexture,fe=gt(T);if(T.depthTexture.format===ml)Pe(T)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ve,0,fe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ve,0);else if(T.depthTexture.format===Qs)Pe(T)?f.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ve,0,fe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ve,0);else throw new Error("Unknown depthTexture format")}function ct(B){const T=r.get(B),ie=B.isWebGLCubeRenderTarget===!0;if(T.__boundDepthTexture!==B.depthTexture){const me=B.depthTexture;if(T.__depthDisposeCallback&&T.__depthDisposeCallback(),me){const ve=()=>{delete T.__boundDepthTexture,delete T.__depthDisposeCallback,me.removeEventListener("dispose",ve)};me.addEventListener("dispose",ve),T.__depthDisposeCallback=ve}T.__boundDepthTexture=me}if(B.depthTexture&&!T.__autoAllocateDepthBuffer){if(ie)throw new Error("target.depthTexture not supported in Cube render targets");const me=B.texture.mipmaps;me&&me.length>0?Xe(T.__webglFramebuffer[0],B):Xe(T.__webglFramebuffer,B)}else if(ie){T.__webglDepthbuffer=[];for(let me=0;me<6;me++)if(t.bindFramebuffer(i.FRAMEBUFFER,T.__webglFramebuffer[me]),T.__webglDepthbuffer[me]===void 0)T.__webglDepthbuffer[me]=i.createRenderbuffer(),qe(T.__webglDepthbuffer[me],B,!1);else{const ve=B.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=T.__webglDepthbuffer[me];i.bindRenderbuffer(i.RENDERBUFFER,fe),i.framebufferRenderbuffer(i.FRAMEBUFFER,ve,i.RENDERBUFFER,fe)}}else{const me=B.texture.mipmaps;if(me&&me.length>0?t.bindFramebuffer(i.FRAMEBUFFER,T.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,T.__webglFramebuffer),T.__webglDepthbuffer===void 0)T.__webglDepthbuffer=i.createRenderbuffer(),qe(T.__webglDepthbuffer,B,!1);else{const ve=B.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,fe=T.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,fe),i.framebufferRenderbuffer(i.FRAMEBUFFER,ve,i.RENDERBUFFER,fe)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Qt(B,T,ie){const me=r.get(B);T!==void 0&&be(me.__webglFramebuffer,B,B.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),ie!==void 0&&ct(B)}function ut(B){const T=B.texture,ie=r.get(B),me=r.get(T);B.addEventListener("dispose",F);const ve=B.textures,fe=B.isWebGLCubeRenderTarget===!0,Ie=ve.length>1;if(Ie||(me.__webglTexture===void 0&&(me.__webglTexture=i.createTexture()),me.__version=T.version,u.memory.textures++),fe){ie.__webglFramebuffer=[];for(let Ne=0;Ne<6;Ne++)if(T.mipmaps&&T.mipmaps.length>0){ie.__webglFramebuffer[Ne]=[];for(let tt=0;tt<T.mipmaps.length;tt++)ie.__webglFramebuffer[Ne][tt]=i.createFramebuffer()}else ie.__webglFramebuffer[Ne]=i.createFramebuffer()}else{if(T.mipmaps&&T.mipmaps.length>0){ie.__webglFramebuffer=[];for(let Ne=0;Ne<T.mipmaps.length;Ne++)ie.__webglFramebuffer[Ne]=i.createFramebuffer()}else ie.__webglFramebuffer=i.createFramebuffer();if(Ie)for(let Ne=0,tt=ve.length;Ne<tt;Ne++){const Ye=r.get(ve[Ne]);Ye.__webglTexture===void 0&&(Ye.__webglTexture=i.createTexture(),u.memory.textures++)}if(B.samples>0&&Pe(B)===!1){ie.__webglMultisampledFramebuffer=i.createFramebuffer(),ie.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,ie.__webglMultisampledFramebuffer);for(let Ne=0;Ne<ve.length;Ne++){const tt=ve[Ne];ie.__webglColorRenderbuffer[Ne]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,ie.__webglColorRenderbuffer[Ne]);const Ye=l.convert(tt.format,tt.colorSpace),Ee=l.convert(tt.type),Re=A(tt.internalFormat,Ye,Ee,tt.colorSpace,B.isXRRenderTarget===!0),Qe=gt(B);i.renderbufferStorageMultisample(i.RENDERBUFFER,Qe,Re,B.width,B.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ne,i.RENDERBUFFER,ie.__webglColorRenderbuffer[Ne])}i.bindRenderbuffer(i.RENDERBUFFER,null),B.depthBuffer&&(ie.__webglDepthRenderbuffer=i.createRenderbuffer(),qe(ie.__webglDepthRenderbuffer,B,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(fe){t.bindTexture(i.TEXTURE_CUBE_MAP,me.__webglTexture),Se(i.TEXTURE_CUBE_MAP,T);for(let Ne=0;Ne<6;Ne++)if(T.mipmaps&&T.mipmaps.length>0)for(let tt=0;tt<T.mipmaps.length;tt++)be(ie.__webglFramebuffer[Ne][tt],B,T,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Ne,tt);else be(ie.__webglFramebuffer[Ne],B,T,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+Ne,0);S(T)&&_(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ie){for(let Ne=0,tt=ve.length;Ne<tt;Ne++){const Ye=ve[Ne],Ee=r.get(Ye);let Re=i.TEXTURE_2D;(B.isWebGL3DRenderTarget||B.isWebGLArrayRenderTarget)&&(Re=B.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Re,Ee.__webglTexture),Se(Re,Ye),be(ie.__webglFramebuffer,B,Ye,i.COLOR_ATTACHMENT0+Ne,Re,0),S(Ye)&&_(Re)}t.unbindTexture()}else{let Ne=i.TEXTURE_2D;if((B.isWebGL3DRenderTarget||B.isWebGLArrayRenderTarget)&&(Ne=B.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(Ne,me.__webglTexture),Se(Ne,T),T.mipmaps&&T.mipmaps.length>0)for(let tt=0;tt<T.mipmaps.length;tt++)be(ie.__webglFramebuffer[tt],B,T,i.COLOR_ATTACHMENT0,Ne,tt);else be(ie.__webglFramebuffer,B,T,i.COLOR_ATTACHMENT0,Ne,0);S(T)&&_(Ne),t.unbindTexture()}B.depthBuffer&&ct(B)}function Rt(B){const T=B.textures;for(let ie=0,me=T.length;ie<me;ie++){const ve=T[ie];if(S(ve)){const fe=w(B),Ie=r.get(ve).__webglTexture;t.bindTexture(fe,Ie),_(fe),t.unbindTexture()}}}const V=[],He=[];function Fe(B){if(B.samples>0){if(Pe(B)===!1){const T=B.textures,ie=B.width,me=B.height;let ve=i.COLOR_BUFFER_BIT;const fe=B.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Ie=r.get(B),Ne=T.length>1;if(Ne)for(let Ye=0;Ye<T.length;Ye++)t.bindFramebuffer(i.FRAMEBUFFER,Ie.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ye,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Ie.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ye,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Ie.__webglMultisampledFramebuffer);const tt=B.texture.mipmaps;tt&&tt.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ie.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ie.__webglFramebuffer);for(let Ye=0;Ye<T.length;Ye++){if(B.resolveDepthBuffer&&(B.depthBuffer&&(ve|=i.DEPTH_BUFFER_BIT),B.stencilBuffer&&B.resolveStencilBuffer&&(ve|=i.STENCIL_BUFFER_BIT)),Ne){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Ie.__webglColorRenderbuffer[Ye]);const Ee=r.get(T[Ye]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ee,0)}i.blitFramebuffer(0,0,ie,me,0,0,ie,me,ve,i.NEAREST),d===!0&&(V.length=0,He.length=0,V.push(i.COLOR_ATTACHMENT0+Ye),B.depthBuffer&&B.resolveDepthBuffer===!1&&(V.push(fe),He.push(fe),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,He)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,V))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),Ne)for(let Ye=0;Ye<T.length;Ye++){t.bindFramebuffer(i.FRAMEBUFFER,Ie.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ye,i.RENDERBUFFER,Ie.__webglColorRenderbuffer[Ye]);const Ee=r.get(T[Ye]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Ie.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ye,i.TEXTURE_2D,Ee,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Ie.__webglMultisampledFramebuffer)}else if(B.depthBuffer&&B.resolveDepthBuffer===!1&&d){const T=B.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[T])}}}function gt(B){return Math.min(o.maxSamples,B.samples)}function Pe(B){const T=r.get(B);return B.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&T.__useRenderToTexture!==!1}function Ot(B){const T=u.render.frame;g.get(B)!==T&&(g.set(B,T),B.update())}function je(B,T){const ie=B.colorSpace,me=B.format,ve=B.type;return B.isCompressedTexture===!0||B.isVideoTexture===!0||ie!==hr&&ie!==Xi&&(Ct.getTransfer(ie)===kt?(me!==Ui||ve!==ci)&&ft("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):cn("WebGLTextures: Unsupported texture color space:",ie)),T}function lt(B){return typeof HTMLImageElement<"u"&&B instanceof HTMLImageElement?(p.width=B.naturalWidth||B.width,p.height=B.naturalHeight||B.height):typeof VideoFrame<"u"&&B instanceof VideoFrame?(p.width=B.displayWidth,p.height=B.displayHeight):(p.width=B.width,p.height=B.height),p}this.allocateTextureUnit=ne,this.resetTextureUnits=j,this.setTexture2D=K,this.setTexture2DArray=I,this.setTexture3D=W,this.setTextureCube=Y,this.rebindTextures=Qt,this.setupRenderTarget=ut,this.updateRenderTargetMipmap=Rt,this.updateMultisampleRenderTarget=Fe,this.setupDepthRenderbuffer=ct,this.setupFrameBufferTexture=be,this.useMultisampledRTT=Pe}function CR(i,e){function t(r,o=Xi){let l;const u=Ct.getTransfer(o);if(r===ci)return i.UNSIGNED_BYTE;if(r===Dp)return i.UNSIGNED_SHORT_4_4_4_4;if(r===Up)return i.UNSIGNED_SHORT_5_5_5_1;if(r===T_)return i.UNSIGNED_INT_5_9_9_9_REV;if(r===A_)return i.UNSIGNED_INT_10F_11F_11F_REV;if(r===M_)return i.BYTE;if(r===E_)return i.SHORT;if(r===pl)return i.UNSIGNED_SHORT;if(r===Cp)return i.INT;if(r===fr)return i.UNSIGNED_INT;if(r===ya)return i.FLOAT;if(r===eo)return i.HALF_FLOAT;if(r===R_)return i.ALPHA;if(r===w_)return i.RGB;if(r===Ui)return i.RGBA;if(r===ml)return i.DEPTH_COMPONENT;if(r===Qs)return i.DEPTH_STENCIL;if(r===C_)return i.RED;if(r===Lp)return i.RED_INTEGER;if(r===Np)return i.RG;if(r===Op)return i.RG_INTEGER;if(r===Pp)return i.RGBA_INTEGER;if(r===lu||r===cu||r===uu||r===fu)if(u===kt)if(l=e.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(r===lu)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===cu)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===uu)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===fu)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=e.get("WEBGL_compressed_texture_s3tc"),l!==null){if(r===lu)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===cu)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===uu)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===fu)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===kd||r===Xd||r===Wd||r===qd)if(l=e.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(r===kd)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Xd)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Wd)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===qd)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===jd||r===Yd||r===Zd)if(l=e.get("WEBGL_compressed_texture_etc"),l!==null){if(r===jd||r===Yd)return u===kt?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(r===Zd)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Kd||r===Qd||r===$d||r===Jd||r===ep||r===tp||r===np||r===ip||r===ap||r===rp||r===sp||r===op||r===lp||r===cp)if(l=e.get("WEBGL_compressed_texture_astc"),l!==null){if(r===Kd)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===Qd)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===$d)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Jd)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===ep)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===tp)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===np)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===ip)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===ap)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===rp)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===sp)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===op)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===lp)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===cp)return u===kt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===up||r===fp||r===hp)if(l=e.get("EXT_texture_compression_bptc"),l!==null){if(r===up)return u===kt?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===fp)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===hp)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===dp||r===pp||r===mp||r===gp)if(l=e.get("EXT_texture_compression_rgtc"),l!==null){if(r===dp)return l.COMPRESSED_RED_RGTC1_EXT;if(r===pp)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===mp)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===gp)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Ks?i.UNSIGNED_INT_24_8:i[r]!==void 0?i[r]:null}return{convert:t}}const DR=`
void main() {
...
\r
My responsibilities included conducting user research, defining the site’s requirements, and designing the admin-facing interface.`,role:["UX","UI","User Research","Front-end Development"],date:"May - June 2025"}),G.jsx(pu,{src:OL,alt:"User and Client story mappings"}),G.jsx(mu,{leftImg:PL,rightImg:BL,leftAlt:"Inspiration Board",rightAlt:"Guerrilla Testing"}),G.jsx(zL,{src:HL})]})}function VL(){return G.jsx(kU,{children:G.jsxs(G.Fragment,{children:[G.jsx(vM,{}),G.jsxs(cb,{children:[G.jsx(sr,{path:"/",element:G.jsx(Iw,{})}),G.jsx(sr,{path:"/mywork",element:G.jsx(Vw,{})}),G.jsx(sr,{path:"/featured-projects/naturhistoriskmuseum",element:G.jsx(NC,{})}),G.jsx(sr,{path:"/featured-projects/spilcafeen",element:G.jsx(GL,{})}),G.jsx(sr,{path:"/about",element:G.jsx(dL,{})}),G.jsx(sr,{path:"/experience",element:G.jsx(zC,{})}),G.jsx(sr,{path:"/featured-projects",element:G.jsx(NL,{})})]})]})})}vS.createRoot(document.getElementById("root")).render(G.jsx(lr.StrictMode,{children:G.jsx(Lb,{children:G.jsx(VL,{})})}));
